...
Загрузить файлы можно по адресу <http://127.0.0.1:8000/api/v1/upload/>
Посмотреть все загруженные файлы и статус их обработки <http://127.0.0.1:8000/api/v1/files/>
